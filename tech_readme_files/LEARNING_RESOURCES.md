...
- [MVC in Flutter - Medium](https://medium.com/@business_16502/flutter-mvc-architecture-pattern-with-getx-c8d3e3e5f9c3)
...
**Videos:**
- YouTube: "Flutter MVVM with GetX - Complete Guide"
...
- [GetX Ecosystem](https://github.com/jonataslaw/getx#the-three-pillars)
  - State management
  - Route management
  - Dependency management

### Tutorials
- [GetX Complete Guide - Medium](https://medium.com/flutter-community/the-flutter-getx-ecosystem-state-management-881c7235511d)
- [GetX vs Other Solutions](https://itnext.io/flutter-state-management-with-getx-vs-bloc-vs-provider-e7ee35cb2dae)

### Video Series
- YouTube: "GetX State Management Tutorial - Complete Series"
- YouTube: "GetX Best Practices"
...
**MVC Architecture:**
- "Flutter MVC Pattern Tutorial" by Reso Coder
- "MVC Architecture in Flutter with GetX"

**MVVM Architecture:**
- "Flutter MVVM Architecture" by Code With Andrea
- "GetX MVVM Complete Tutorial"

**Clean Architecture:**
- "Flutter Clean Architecture - Full Course" by Reso Coder
- "Clean Architecture + TDD" tutorial series
...
- "Flutter Clean Architecture & TDD" by Reso Coder
